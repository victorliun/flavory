...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Consolas" ;"Source Code Pro"
                               :size 13
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
